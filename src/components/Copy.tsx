...
return (
    <>
        <button  type="button" onClick={copyToClipboard} className="flex items-center text-lg font-medium text-gray-600 bg-gray-100 dark:border-gray-600 dark:text-gray-400 dark:bg-gray-800 hover:text-blue-700 dark:hover:text-white copy-to-clipboard-button">
        ...
        </svg> <span className="copy-text"></span>
        </button>

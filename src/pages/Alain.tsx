...
export default function Alain() {
    ...
    return(
        <>
        <h1 className="text-2xl dark:text-white my-1 font-semibold">
            Alain STERBIK
        </h1>
        ...
        <div className="container">
            ...
            développer sur les marchés internationaux :
                ...
                <ul className="my-3 mx-3">
                    <li> • Solutions sur mesure : Chaque entreprise étant unique, j’élabore des stratégies adaptées à vos besoins spécifiques et à vos objectifs.</li>
                    <li> • Engagement envers l’excellence : Mon objectif est de livrer des résultats de haute qualité, en me concentrant sur une croissance durable et pérenne.</li>
                </ul>
            </div>
            ...
            <div className="mb-3 text-gray-500 dark:text-gray-400">
                <ul className="my-3 mx-3">
                    <li>• Consultation initiale offerte : Nous échangeons pour mieux comprendre vos besoins et les défis
                    auxquels vous faites face.</li>
                    <li>• Stratégie personnalisée : Un plan d’action est élaboré en accord avec vos objectifs de
                    développement.</li>
                    <li>• Suivi régulier : J’assure un accompagnement tout au long de l’exécution pour garantir la mise en
            ...
            <ul className="my-3 mx-3">
                <li className="flex items-center px-3 py-2 text-lg font-medium text-gray-600 bg-gray-100 border-l border-gray-200 dark:border-gray-600 dark:text-gray-400 dark:bg-gray-800 hover:text-blue-700 dark:hover:text-white copy-to-clipboard-button">
                ...
                <li>
                    <a href="https://www.linkedin.com/in/alain-sterbik-0b63932/" className="flex items-center px-3 py-2 text-lg font-medium text-gray-600 bg-gray-100 border-l border-gray-200 dark:border-gray-600 dark:text-gray-400 dark:bg-gray-800 hover:text-blue-700 dark:hover:text-white">
